...
void dist_Fx_predInit_cb(const std_msgs::Bool::ConstPtr& msg)
{
    ...
    if(dist_Fx.predInit && dist_Fx.print_predInit == 1)
    {
...
void dist_Fy_predInit_cb(const std_msgs::Bool::ConstPtr& msg)
{
    ...
    if(dist_Fy.predInit && dist_Fy.print_predInit == 1)
    {
...
void dist_Fz_predInit_cb(const std_msgs::Bool::ConstPtr& msg)
{
    ...
    if(dist_Fz.predInit && dist_Fz.print_predInit == 1)
    {
...
int main(int argc, char **argv)
{
    ...
    ros::param::get("verbose_nmpc",nmpc_struct.verbose);
